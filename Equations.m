...
%       C_gas   = [C_C2H6(i,k) C_C2H4(i,k) C_O2(i,k) C_CO2(i,k) C_CO(i,k) C_H2O(i,k) C_N2(i,k)];
        ...
        E_Cpf= Cpf(i,k) - (((Components(1).cp_R(1) + Components(1).cp_R(2)*T(i,k) + Components(1).cp_R(3)*T(i,k)^2 + Components(1).cp_R(4)*T(i,k)^(-2))*R)*(C_C2H6(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))) ...
            ...
            - (((Components(3).cp_R(1) + Components(3).cp_R(2)*T(i,k) + Components(3).cp_R(3)*T(i,k)^2 + Components(3).cp_R(4)*T(i,k)^(-2))*R)*(C_O2(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))) ...
            - (((Components(4).cp_R(1) + Components(4).cp_R(2)*T(i,k) + Components(4).cp_R(3)*T(i,k)^2 + Components(4).cp_R(4)*T(i,k)^(-2))*R)*(C_CO2(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))) ...
            - (((Components(5).cp_R(1) + Components(5).cp_R(2)*T(i,k) + Components(5).cp_R(3)*T(i,k)^2 + Components(5).cp_R(4)*T(i,k)^(-2))*R)*(C_CO(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))) ...
            - (((Components(6).cp_R(1) + Components(6).cp_R(2)*T(i,k) + Components(6).cp_R(3)*T(i,k)^2 + Components(6).cp_R(4)*T(i,k)^(-2))*R)*(C_H2O(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))) ...
            - (((Components(7).cp_R(1) + Components(7).cp_R(2)*T(i,k) + Components(7).cp_R(3)*T(i,k)^2 + Components(7).cp_R(4)*T(i,k)^(-2))*R)*(C_N2(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k))));
